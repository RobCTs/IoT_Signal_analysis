...
/** RMT_CH4DATA : HRO; bitpos: [31:0]; default: 0;
 *  Read and write data for channel $n via APB FIFO.
 */
...
/** RMT_CH5DATA : HRO; bitpos: [31:0]; default: 0;
 *  Read and write data for channel $n via APB FIFO.
 */
...
/** RMT_CH6DATA : HRO; bitpos: [31:0]; default: 0;
 *  Read and write data for channel $n via APB FIFO.
 */
...
/** RMT_CH7DATA : HRO; bitpos: [31:0]; default: 0;
 *  Read and write data for channel $n via APB FIFO.
 */
 ...
 *  Set this bit to reset read ram address for CHANNEL$n by accessing transmitter.
 */
 ...
 *  This is the channel $n enable bit for wraparound mode: it will resume sending at
 ...
 *  This bit configures the level of output signal in CHANNEL$n when the latter is in
 *  IDLE state.
 */
 ...
 *  This is the output enable-control bit for CHANNEL$n in IDLE state.
 */
 ...
 *  This register is used to configure the divider for clock of CHANNEL$n.
 */
 ...
 *  This register is used to configure the maximum size of memory allocated to
 *  CHANNEL$n.
 */
 ...
 *  CHANNEL$n. 0: Add carrier modulation on the output signal at all state for
 *  CHANNEL$n. Only valid when RMT_CARRIER_EN_CH$n is 1.
 */
 ...
 *  This is the carrier modulation enable-control bit for CHANNEL$n. 1: Add carrier
 ...
 *  This bit is used to configure the position of carrier wave for CHANNEL$n.1'h0: add
 *  carrier wave on low level.1'h1: add carrier wave on high level.
 */
...
/** RMT_DMA_ACCESS_EN_CH3 : R/W; bitpos: [25]; default: 0;
 *  This bit is used to enable the dma access function for CHANNEL$n.
 */
#define RMT_DMA_ACCESS_EN_CH3    (BIT(25))
#define RMT_DMA_ACCESS_EN_CH3_M  (RMT_DMA_ACCESS_EN_CH3_V << RMT_DMA_ACCESS_EN_CH3_S)
#define RMT_DMA_ACCESS_EN_CH3_V  0x00000001U
 ...
 *  This register is used to configure the divider for clock of CHANNEL$m.
 */
 ...
 *  This is the carrier modulation enable-control bit for CHANNEL$m. 1: Add carrier
 *  modulation in the output signal. 0: No carrier modulation in sig_out.
 */
 ...
 *  This bit is used to configure the position of carrier wave for CHANNEL$m.1'h0: add
 *  carrier wave on low level.1'h1: add carrier wave on high level.
 */
 ...
 *  Set this bit to enable receiver to receive data on CHANNEL$m.
 */
 ...
 *  Set this bit to reset write ram address for CHANNEL$m by accessing receiver.
 */
 ...
 *  Set this bit to reset W/R ram address for CHANNEL$m by accessing apb fifo.
 */
 ...
 *  This register marks the ownership of CHANNEL$m's ram block.1'h1: Receiver is using
 *  the ram. 1'h0: APB bus is using the ram.
 */
 ...
 *  This is the receive filter's enable bit for CHANNEL$m.
 */
...
/** RMT_DMA_ACCESS_EN_CH7 : R/W; bitpos: [23]; default: 0;
 *  This bit is used to enable the dma access function for CHANNEL$m.
 */
#define RMT_DMA_ACCESS_EN_CH7    (BIT(23))
#define RMT_DMA_ACCESS_EN_CH7_M  (RMT_DMA_ACCESS_EN_CH7_V << RMT_DMA_ACCESS_EN_CH7_S)
#define RMT_DMA_ACCESS_EN_CH7_V  0x00000001U
 ...
 *  This register records the memory address offset when transmitter of CHANNEL$n is
 *  using the RAM.
 */
 ...
 *  This register records the FSM status of CHANNEL$n.
 */
...
/** RMT_MEM_RADDR_EX_CH1 : RO; bitpos: [9:0]; default: 48;
 *  This register records the memory address offset when transmitter of CHANNEL$n is
 *  using the RAM.
 */
...
/** RMT_APB_MEM_WADDR_CH1 : RO; bitpos: [20:11]; default: 48;
 *  This register records the memory address offset when writes RAM over APB bus.
 */
...
/** RMT_MEM_RADDR_EX_CH2 : RO; bitpos: [9:0]; default: 96;
 *  This register records the memory address offset when transmitter of CHANNEL$n is
 *  using the RAM.
 */
...
/** RMT_APB_MEM_WADDR_CH2 : RO; bitpos: [20:11]; default: 96;
 *  This register records the memory address offset when writes RAM over APB bus.
 */
...
/** RMT_MEM_RADDR_EX_CH3 : RO; bitpos: [9:0]; default: 144;
 *  This register records the memory address offset when transmitter of CHANNEL$n is
 *  using the RAM.
 */
...
/** RMT_APB_MEM_WADDR_CH3 : RO; bitpos: [20:11]; default: 144;
 *  This register records the memory address offset when writes RAM over APB bus.
 */
 ...
 *  This register records the memory address offset when receiver of CHANNEL$m is using
 *  the RAM.
 */
 ...
 *  This register records the FSM status of CHANNEL$m.
 */
...
/** RMT_MEM_WADDR_EX_CH5 : RO; bitpos: [9:0]; default: 240;
 *  This register records the memory address offset when receiver of CHANNEL$m is using
 *  the RAM.
 */
...
/** RMT_APB_MEM_RADDR_CH5 : RO; bitpos: [20:11]; default: 240;
 *  This register records the memory address offset when reads RAM over APB bus.
 */
...
/** RMT_MEM_WADDR_EX_CH6 : RO; bitpos: [9:0]; default: 288;
 *  This register records the memory address offset when receiver of CHANNEL$m is using
 *  the RAM.
 */
...
/** RMT_APB_MEM_RADDR_CH6 : RO; bitpos: [20:11]; default: 288;
 *  This register records the memory address offset when reads RAM over APB bus.
 */
...
/** RMT_MEM_WADDR_EX_CH7 : RO; bitpos: [9:0]; default: 336;
 *  This register records the memory address offset when receiver of CHANNEL$m is using
 *  the RAM.
 */
...
/** RMT_APB_MEM_RADDR_CH7 : RO; bitpos: [20:11]; default: 336;
 *  This register records the memory address offset when reads RAM over APB bus.
 */
 ...
 *  The interrupt raw bit for CHANNEL$n. Triggered when transmission done.
 */
 ...
 *  The interrupt raw bit for CHANNEL$n. Triggered when error occurs.
 */
 ...
 *  The interrupt raw bit for CHANNEL$n. Triggered when transmitter sent more data than
 *  configured value.
 */
 ...
 *  The interrupt raw bit for CHANNEL$n. Triggered when the loop count reaches the
 ...
 *  The interrupt raw bit for CHANNEL$m. Triggered when reception done.
 */
 ...
 *  The interrupt raw bit for CHANNEL$m. Triggered when receiver receive more data than
 *  configured value.
 */
 ...
 *  The interrupt raw bit for CHANNEL$n. Triggered when dma accessing CHANNEL$n fails.
 */
 ...
 *  The interrupt raw bit for CHANNEL$m. Triggered when dma accessing CHANNEL$m fails.
 */
 ...
 *  The masked interrupt status bit for CH$n_TX_END_INT.
 */
 ...
 *  The masked interrupt status bit for CH$n_TX_THR_EVENT_INT.
 */
 ...
 *  The masked interrupt status bit for CH$n_TX_LOOP_INT.
 */
 ...
 *  The masked interrupt status bit for CH$m_RX_END_INT.
 */
 ...
 *  The masked interrupt status bit for CH$m_ERR_INT.
 */
 ...
 *  The masked interrupt status bit for CH$m_RX_THR_EVENT_INT.
 */
 ...
 *  The masked interrupt status bit for  CH$n_DMA_ACCESS_FAIL_INT.
 */
 ...
 *  The masked interrupt status bit for  CH$m_DMA_ACCESS_FAIL_INT.
 */
 ...
 *  The interrupt enable bit for CH$n_TX_END_INT.
 */
 ...
 *  The interrupt enable bit for CH$n_TX_THR_EVENT_INT.
 */
 ...
 *  The interrupt enable bit for CH$n_TX_LOOP_INT.
 */
 ...
 *  The interrupt enable bit for CH$m_RX_END_INT.
 */
 ...
 *  The interrupt enable bit for CH$m_ERR_INT.
 */
 ...
 *  The interrupt enable bit for CH$m_RX_THR_EVENT_INT.
 */
 ...
 *  The interrupt enable bit for CH$n_DMA_ACCESS_FAIL_INT.
 */
 ...
 *  The interrupt enable bit for CH$m_DMA_ACCESS_FAIL_INT.
 */
 ...
 *  Set this bit to clear theCH$n_TX_END_INT interrupt.
 */
 ...
 *  Set this bit to clear theCH$n_TX_THR_EVENT_INT interrupt.
 */
 ...
 *  Set this bit to clear theCH$n_TX_LOOP_INT interrupt.
 */
 ...
 *  Set this bit to clear theCH$m_RX_END_INT interrupt.
 */
 ...
 *  Set this bit to clear theCH$m_ERR_INT interrupt.
 */
 ...
 *  Set this bit to clear theCH$m_RX_THR_EVENT_INT interrupt.
 */
 ...
 *  Set this bit to clear the CH$n_DMA_ACCESS_FAIL_INT interrupt.
 */
 ...
 *  Set this bit to clear the CH$m_DMA_ACCESS_FAIL_INT interrupt.
 */
 ...
 *  (REG_RMT_REG_CARRIER_LOW_THRES_CH$m + 1) for channel $m.
 */
 ...
 *  (REG_RMT_REG_CARRIER_HIGH_THRES_CH$m + 1) for channel $m.
 */
 ...
 *  This register is used to configure the maximum entries that CHANNEL$n can send out.
 */
 ...
 *  This register is used to configure the maximum entries that CHANNEL$m can receive.
 */
 ...
 *  Set this bit to enable CHANNEL$n to start sending data synchronously with other
 *  enabled channels.
 */
 ...
 *  This register is used to reset the clock divider of CHANNEL$n.
 */
 ...
 *  This register is used to reset the clock divider of CHANNEL$m.
 */
...
/** RMT_DATE : R/W; bitpos: [27:0]; default: 35655953;
