...
// TODO: [ESP32C61] IDF-9314, This file comes from verification code
#ifdef __cplusplus
extern "C" {
#endif
#include "soc.h"
...
/* SPI_MEM_AXI_RDATA_BACK_FAST : R/W ;bitpos:[23] ;default: 1'b1 ; */
...
/* SPI_MEM_SAME_AW_AR_ADDR_CHK_EN : R/W ;bitpos:[30] ;default: 1'b1 ; */
...
/* SPI_MEM_SMEM_DATA_IE_ALWAYS_ON : R/W ;bitpos:[31] ;default: 1'b1 ; */
...
/* SPI_MEM_SMEM_DQS_IE_ALWAYS_ON : R/W ;bitpos:[30] ;default: 1'b0 ; */
...
/* SPI_MEM_SDOUT_HEX : HRO ;bitpos:[27] ;default: 1'b0 ; */
...
/* SPI_MEM_SDIN_HEX : HRO ;bitpos:[26] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_WDUMMY_ALWAYS_OUT : R/W ;bitpos:[25] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_WDUMMY_DQS_ALWAYS_OUT : R/W ;bitpos:[24] ;default: 1'b0 ; */
/*description: In the dummy phase of an MSPI write data transfer when accesses to external RAM,
...
/* SPI_MEM_FMEM_HYPERBUS_CA : R/W ;bitpos:[30] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_OCTA_RAM_ADDR : R/W ;bitpos:[29] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_CLK_DIFF_INV : R/W ;bitpos:[28] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_HYPERBUS_DUMMY_2X : R/W ;bitpos:[27] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_DQS_CA_IN : R/W ;bitpos:[26] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_CLK_DIFF_EN : R/W ;bitpos:[24] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_DDR_DQS_LOOP : R/W ;bitpos:[21] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_USR_DDR_DQS_THD : R/W ;bitpos:[20:14] ;default: 7'b0 ; */
...
/* SPI_MEM_FMEM_RX_DDR_MSK_EN : R/W ;bitpos:[13] ;default: 1'h1 ; */
...
/* SPI_MEM_FMEM_TX_DDR_MSK_EN : R/W ;bitpos:[12] ;default: 1'h1 ; */
...
/* SPI_MEM_FMEM_OUTMINBYTELEN : R/W ;bitpos:[11:5] ;default: 7'b1 ; */
...
/* SPI_MEM_FMEM_DDR_CMD_DIS : R/W ;bitpos:[4] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_DDR_WDAT_SWP : R/W ;bitpos:[3] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_DDR_RDAT_SWP : R/W ;bitpos:[2] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_VAR_DUMMY : R/W ;bitpos:[1] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_DDR_EN : R/W ;bitpos:[0] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_HYPERBUS_CA : R/W ;bitpos:[30] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_OCTA_RAM_ADDR : R/W ;bitpos:[29] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_CLK_DIFF_INV : R/W ;bitpos:[28] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_HYPERBUS_DUMMY_2X : R/W ;bitpos:[27] ;default: 1'b0 ; */
/*description: Set this bit to enable the vary dummy function in SPI HyperBus mode, when SPI0 a
ccesses flash or SPI1 accesses flash or sram..*/
...
/* SPI_MEM_SMEM_DQS_CA_IN : R/W ;bitpos:[26] ;default: 1'b0 ; */
/*description: Set this bit to enable the input of SPI_DQS signal in SPI phases of CMD and ADDR
..*/
...
/* SPI_MEM_SMEM_CLK_DIFF_EN : R/W ;bitpos:[24] ;default: 1'b0 ; */
/*description: Set this bit to enable the differential SPI_CLK#..*/
...
/* SPI_MEM_SMEM_DDR_DQS_LOOP : R/W ;bitpos:[21] ;default: 1'b0 ; */
/*description: 1: Do not need the input of SPI_DQS signal, SPI0 starts to receive data when spi
0_slv_st is in SPI_MEM_DIN state. It is used when there is no SPI_DQS signal or
SPI_DQS signal is not stable. 0: SPI0 starts to store data at the positive and n
egative edge of SPI_DQS..*/
...
/* SPI_MEM_SMEM_USR_DDR_DQS_THD : R/W ;bitpos:[20:14] ;default: 7'b0 ; */
/*description: The delay number of data strobe which from memory based on SPI clock..*/
...
/* SPI_MEM_SMEM_RX_DDR_MSK_EN : R/W ;bitpos:[13] ;default: 1'h1 ; */
/*description: Set this bit to mask the first or the last byte in SPI0 ECC DDR read mode, when
...
/* SPI_MEM_SMEM_TX_DDR_MSK_EN : R/W ;bitpos:[12] ;default: 1'h1 ; */
/*description: Set this bit to mask the first or the last byte in SPI0 ECC DDR write mode, when
 accesses to external RAM..*/
...
/* SPI_MEM_SMEM_OUTMINBYTELEN : R/W ;bitpos:[11:5] ;default: 7'b1 ; */
...
/* SPI_MEM_SMEM_DDR_CMD_DIS : R/W ;bitpos:[4] ;default: 1'b0 ; */
/*description: the bit is used to disable dual edge in command phase when DDR mode..*/
...
/* SPI_MEM_SMEM_DDR_WDAT_SWP : R/W ;bitpos:[3] ;default: 1'b0 ; */
/*description: Set the bit to reorder tx data of the word in spi DDR mode..*/
...
/* SPI_MEM_SMEM_DDR_RDAT_SWP : R/W ;bitpos:[2] ;default: 1'b0 ; */
/*description: Set the bit to reorder rx data of the word in spi DDR mode..*/
...
/* SPI_MEM_SMEM_VAR_DUMMY : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: Set the bit to enable variable dummy cycle in spi DDR mode..*/
...
/* SPI_MEM_SMEM_DDR_EN : R/W ;bitpos:[0] ;default: 1'b0 ; */
/*description: 1: in DDR mode,  0 in SDR mode.*/
...
/* SPI_MEM_FMEM_ECC_ADDR_EN : R/W ;bitpos:[21] ;default: 1'd0 ; */
...
#define SPI_MEM_FMEM_ECC_ADDR_EN    (BIT(21))
#define SPI_MEM_FMEM_ECC_ADDR_EN_M  (BIT(21))
#define SPI_MEM_FMEM_ECC_ADDR_EN_V  0x1
#define SPI_MEM_FMEM_ECC_ADDR_EN_S  21
...
/* SPI_MEM_FMEM_ECC_ERR_INT_EN : R/W ;bitpos:[17] ;default: 1'b0 ; */
...
/* SPI_MEM_FMEM_ECC_ERR_INT_NUM : R/W ;bitpos:[16:11] ;default: 6'd10 ; */
...
/* SPI_MEM_SMEM_ECC_ADDR_EN : R/W ;bitpos:[20] ;default: 1'd0 ; */
/*description: Set this bit to enable MSPI ECC address conversion, no matter MSPI accesses to t
...
/* SPI_MEM_SMEM_PAGE_SIZE : R/W ;bitpos:[19:18] ;default: 2'd2 ; */
...
/* SPI_MEM_SMEM_ECC_ERR_INT_EN : R/W ;bitpos:[17] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_DQS0_90_SEL : R/W ;bitpos:[10:9] ;default: 2'd1 ; */
/*description: Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0
ns, 2'd2: 1.5ns 2'd3: 2.0ns..*/
#define SPI_MEM_SMEM_DQS0_90_SEL    0x00000003
#define SPI_MEM_SMEM_DQS0_90_SEL_M  ((SPI_MEM_SMEM_DQS0_90_SEL_V)<<(SPI_MEM_SMEM_DQS0_90_SEL_S))
#define SPI_MEM_SMEM_DQS0_90_SEL_V  0x3
#define SPI_MEM_SMEM_DQS0_90_SEL_S  9
/* SPI_MEM_SMEM_DQS0_270_SEL : R/W ;bitpos:[8:7] ;default: 2'd1 ; */
...
#define SPI_MEM_SMEM_DQS0_270_SEL    0x00000003
#define SPI_MEM_SMEM_DQS0_270_SEL_M  ((SPI_MEM_SMEM_DQS0_270_SEL_V)<<(SPI_MEM_SMEM_DQS0_270_SEL_S))
#define SPI_MEM_SMEM_DQS0_270_SEL_V  0x3
#define SPI_MEM_SMEM_DQS0_270_SEL_S  7
/* SPI_MEM_SMEM_DLL_TIMING_CALI : R/W ;bitpos:[5] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_EXTRA_DUMMY_CYCLELEN : R/W ;bitpos:[4:2] ;default: 3'd0 ; */
...
/* SPI_MEM_SMEM_TIMING_CALI : R/W ;bitpos:[1] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_TIMING_CLK_ENA : R/W ;bitpos:[0] ;default: 1'b1 ; */
...
/* SPI_MEM_SMEM_DINS_MODE : R/W ;bitpos:[26:24] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN7_MODE : R/W ;bitpos:[23:21] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN6_MODE : R/W ;bitpos:[20:18] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN5_MODE : R/W ;bitpos:[17:15] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN4_MODE : R/W ;bitpos:[14:12] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN3_MODE : R/W ;bitpos:[11:9] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN2_MODE : R/W ;bitpos:[8:6] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN1_MODE : R/W ;bitpos:[5:3] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DIN0_MODE : R/W ;bitpos:[2:0] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DINS_NUM : R/W ;bitpos:[17:16] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN7_NUM : R/W ;bitpos:[15:14] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN6_NUM : R/W ;bitpos:[13:12] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN5_NUM : R/W ;bitpos:[11:10] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN4_NUM : R/W ;bitpos:[9:8] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN3_NUM : R/W ;bitpos:[7:6] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN2_NUM : R/W ;bitpos:[5:4] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN1_NUM : R/W ;bitpos:[3:2] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DIN0_NUM : R/W ;bitpos:[1:0] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
...
/* SPI_MEM_SMEM_DOUTS_MODE : R/W ;bitpos:[8] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT7_MODE : R/W ;bitpos:[7] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT6_MODE : R/W ;bitpos:[6] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT5_MODE : R/W ;bitpos:[5] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT4_MODE : R/W ;bitpos:[4] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT3_MODE : R/W ;bitpos:[3] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT2_MODE : R/W ;bitpos:[2] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT1_MODE : R/W ;bitpos:[1] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_DOUT0_MODE : R/W ;bitpos:[0] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
...
/* SPI_MEM_SMEM_SPLIT_TRANS_EN : R/W ;bitpos:[31] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_ECC_16TO18_BYTE_EN : R/W ;bitpos:[16] ;default: 1'b0 ; */
/*description: Set this bit to enable SPI0 and SPI1 ECC 16 bytes data with 2 ECC bytes mode whe
...
/* SPI_MEM_SMEM_ECC_SKIP_PAGE_CORNER : R/W ;bitpos:[15] ;default: 1'b1 ; */
...
/* SPI_MEM_SMEM_ECC_CS_HOLD_TIME : R/W ;bitpos:[14:12] ;default: 3'd3 ; */
...
/* SPI_MEM_SMEM_CS_HOLD_TIME : R/W ;bitpos:[11:7] ;default: 5'h1 ; */
...
/* SPI_MEM_SMEM_CS_SETUP_TIME : R/W ;bitpos:[6:2] ;default: 5'h1 ; */
...
/* SPI_MEM_SMEM_CS_HOLD : R/W ;bitpos:[1] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_CS_SETUP : R/W ;bitpos:[0] ;default: 1'b0 ; */
...
/* SPI_MEM_SMEM_DINS_HEX_MODE : HRO ;bitpos:[26:24] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DINS_HEX_MODE    0x00000007
#define SPI_MEM_SMEM_DINS_HEX_MODE_M  ((SPI_MEM_SMEM_DINS_HEX_MODE_V)<<(SPI_MEM_SMEM_DINS_HEX_MODE_S))
#define SPI_MEM_SMEM_DINS_HEX_MODE_V  0x7
#define SPI_MEM_SMEM_DINS_HEX_MODE_S  24
/* SPI_MEM_SMEM_DIN15_MODE : HRO ;bitpos:[23:21] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN15_MODE    0x00000007
#define SPI_MEM_SMEM_DIN15_MODE_M  ((SPI_MEM_SMEM_DIN15_MODE_V)<<(SPI_MEM_SMEM_DIN15_MODE_S))
#define SPI_MEM_SMEM_DIN15_MODE_V  0x7
#define SPI_MEM_SMEM_DIN15_MODE_S  21
/* SPI_MEM_SMEM_DIN14_MODE : HRO ;bitpos:[20:18] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN14_MODE    0x00000007
#define SPI_MEM_SMEM_DIN14_MODE_M  ((SPI_MEM_SMEM_DIN14_MODE_V)<<(SPI_MEM_SMEM_DIN14_MODE_S))
#define SPI_MEM_SMEM_DIN14_MODE_V  0x7
#define SPI_MEM_SMEM_DIN14_MODE_S  18
/* SPI_MEM_SMEM_DIN13_MODE : HRO ;bitpos:[17:15] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN13_MODE    0x00000007
#define SPI_MEM_SMEM_DIN13_MODE_M  ((SPI_MEM_SMEM_DIN13_MODE_V)<<(SPI_MEM_SMEM_DIN13_MODE_S))
#define SPI_MEM_SMEM_DIN13_MODE_V  0x7
#define SPI_MEM_SMEM_DIN13_MODE_S  15
/* SPI_MEM_SMEM_DIN12_MODE : HRO ;bitpos:[14:12] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN12_MODE    0x00000007
#define SPI_MEM_SMEM_DIN12_MODE_M  ((SPI_MEM_SMEM_DIN12_MODE_V)<<(SPI_MEM_SMEM_DIN12_MODE_S))
#define SPI_MEM_SMEM_DIN12_MODE_V  0x7
#define SPI_MEM_SMEM_DIN12_MODE_S  12
/* SPI_MEM_SMEM_DIN11_MODE : HRO ;bitpos:[11:9] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN11_MODE    0x00000007
#define SPI_MEM_SMEM_DIN11_MODE_M  ((SPI_MEM_SMEM_DIN11_MODE_V)<<(SPI_MEM_SMEM_DIN11_MODE_S))
#define SPI_MEM_SMEM_DIN11_MODE_V  0x7
#define SPI_MEM_SMEM_DIN11_MODE_S  9
/* SPI_MEM_SMEM_DIN10_MODE : HRO ;bitpos:[8:6] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN10_MODE    0x00000007
#define SPI_MEM_SMEM_DIN10_MODE_M  ((SPI_MEM_SMEM_DIN10_MODE_V)<<(SPI_MEM_SMEM_DIN10_MODE_S))
#define SPI_MEM_SMEM_DIN10_MODE_V  0x7
#define SPI_MEM_SMEM_DIN10_MODE_S  6
/* SPI_MEM_SMEM_DIN09_MODE : HRO ;bitpos:[5:3] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN09_MODE    0x00000007
#define SPI_MEM_SMEM_DIN09_MODE_M  ((SPI_MEM_SMEM_DIN09_MODE_V)<<(SPI_MEM_SMEM_DIN09_MODE_S))
#define SPI_MEM_SMEM_DIN09_MODE_V  0x7
#define SPI_MEM_SMEM_DIN09_MODE_S  3
/* SPI_MEM_SMEM_DIN08_MODE : HRO ;bitpos:[2:0] ;default: 3'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: input without delayed,
1: input with the posedge of clk_apb,2 input with the negedge of clk_apb,  3: in
put with the posedge of clk_160, 4 input with the negedge of clk_160, 5: input w
ith the spi_clk high edge,  6: input with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DIN08_MODE    0x00000007
#define SPI_MEM_SMEM_DIN08_MODE_M  ((SPI_MEM_SMEM_DIN08_MODE_V)<<(SPI_MEM_SMEM_DIN08_MODE_S))
#define SPI_MEM_SMEM_DIN08_MODE_V  0x7
#define SPI_MEM_SMEM_DIN08_MODE_S  0

#define SPI_MEM_SPI_SMEM_DIN_HEX_NUM_REG(i)          (REG_SPI_MEM_BASE(i) + 0x1A8)
/* SPI_MEM_SMEM_DINS_HEX_NUM : HRO ;bitpos:[17:16] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DINS_HEX_NUM    0x00000003
#define SPI_MEM_SMEM_DINS_HEX_NUM_M  ((SPI_MEM_SMEM_DINS_HEX_NUM_V)<<(SPI_MEM_SMEM_DINS_HEX_NUM_S))
#define SPI_MEM_SMEM_DINS_HEX_NUM_V  0x3
#define SPI_MEM_SMEM_DINS_HEX_NUM_S  16
/* SPI_MEM_SMEM_DIN15_NUM : HRO ;bitpos:[15:14] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN15_NUM    0x00000003
#define SPI_MEM_SMEM_DIN15_NUM_M  ((SPI_MEM_SMEM_DIN15_NUM_V)<<(SPI_MEM_SMEM_DIN15_NUM_S))
#define SPI_MEM_SMEM_DIN15_NUM_V  0x3
#define SPI_MEM_SMEM_DIN15_NUM_S  14
/* SPI_MEM_SMEM_DIN14_NUM : HRO ;bitpos:[13:12] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN14_NUM    0x00000003
#define SPI_MEM_SMEM_DIN14_NUM_M  ((SPI_MEM_SMEM_DIN14_NUM_V)<<(SPI_MEM_SMEM_DIN14_NUM_S))
#define SPI_MEM_SMEM_DIN14_NUM_V  0x3
#define SPI_MEM_SMEM_DIN14_NUM_S  12
/* SPI_MEM_SMEM_DIN13_NUM : HRO ;bitpos:[11:10] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN13_NUM    0x00000003
#define SPI_MEM_SMEM_DIN13_NUM_M  ((SPI_MEM_SMEM_DIN13_NUM_V)<<(SPI_MEM_SMEM_DIN13_NUM_S))
#define SPI_MEM_SMEM_DIN13_NUM_V  0x3
#define SPI_MEM_SMEM_DIN13_NUM_S  10
/* SPI_MEM_SMEM_DIN12_NUM : HRO ;bitpos:[9:8] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN12_NUM    0x00000003
#define SPI_MEM_SMEM_DIN12_NUM_M  ((SPI_MEM_SMEM_DIN12_NUM_V)<<(SPI_MEM_SMEM_DIN12_NUM_S))
#define SPI_MEM_SMEM_DIN12_NUM_V  0x3
#define SPI_MEM_SMEM_DIN12_NUM_S  8
/* SPI_MEM_SMEM_DIN11_NUM : HRO ;bitpos:[7:6] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN11_NUM    0x00000003
#define SPI_MEM_SMEM_DIN11_NUM_M  ((SPI_MEM_SMEM_DIN11_NUM_V)<<(SPI_MEM_SMEM_DIN11_NUM_S))
#define SPI_MEM_SMEM_DIN11_NUM_V  0x3
#define SPI_MEM_SMEM_DIN11_NUM_S  6
/* SPI_MEM_SMEM_DIN10_NUM : HRO ;bitpos:[5:4] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN10_NUM    0x00000003
#define SPI_MEM_SMEM_DIN10_NUM_M  ((SPI_MEM_SMEM_DIN10_NUM_V)<<(SPI_MEM_SMEM_DIN10_NUM_S))
#define SPI_MEM_SMEM_DIN10_NUM_V  0x3
#define SPI_MEM_SMEM_DIN10_NUM_S  4
/* SPI_MEM_SMEM_DIN09_NUM : HRO ;bitpos:[3:2] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN09_NUM    0x00000003
#define SPI_MEM_SMEM_DIN09_NUM_M  ((SPI_MEM_SMEM_DIN09_NUM_V)<<(SPI_MEM_SMEM_DIN09_NUM_S))
#define SPI_MEM_SMEM_DIN09_NUM_V  0x3
#define SPI_MEM_SMEM_DIN09_NUM_S  2
/* SPI_MEM_SMEM_DIN08_NUM : HRO ;bitpos:[1:0] ;default: 2'h0 ; */
/*description: the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1:
delayed by 2 cycles,....*/
#define SPI_MEM_SMEM_DIN08_NUM    0x00000003
#define SPI_MEM_SMEM_DIN08_NUM_M  ((SPI_MEM_SMEM_DIN08_NUM_V)<<(SPI_MEM_SMEM_DIN08_NUM_S))
#define SPI_MEM_SMEM_DIN08_NUM_V  0x3
#define SPI_MEM_SMEM_DIN08_NUM_S  0

#define SPI_MEM_SPI_SMEM_DOUT_HEX_MODE_REG(i)          (REG_SPI_MEM_BASE(i) + 0x1AC)
/* SPI_MEM_SMEM_DOUTS_HEX_MODE : HRO ;bitpos:[8] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUTS_HEX_MODE    (BIT(8))
#define SPI_MEM_SMEM_DOUTS_HEX_MODE_M  (BIT(8))
#define SPI_MEM_SMEM_DOUTS_HEX_MODE_V  0x1
#define SPI_MEM_SMEM_DOUTS_HEX_MODE_S  8
/* SPI_MEM_SMEM_DOUT15_MODE : HRO ;bitpos:[7] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT15_MODE    (BIT(7))
#define SPI_MEM_SMEM_DOUT15_MODE_M  (BIT(7))
#define SPI_MEM_SMEM_DOUT15_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT15_MODE_S  7
/* SPI_MEM_SMEM_DOUT14_MODE : HRO ;bitpos:[6] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT14_MODE    (BIT(6))
#define SPI_MEM_SMEM_DOUT14_MODE_M  (BIT(6))
#define SPI_MEM_SMEM_DOUT14_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT14_MODE_S  6
/* SPI_MEM_SMEM_DOUT13_MODE : HRO ;bitpos:[5] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT13_MODE    (BIT(5))
#define SPI_MEM_SMEM_DOUT13_MODE_M  (BIT(5))
#define SPI_MEM_SMEM_DOUT13_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT13_MODE_S  5
/* SPI_MEM_SMEM_DOUT12_MODE : HRO ;bitpos:[4] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT12_MODE    (BIT(4))
#define SPI_MEM_SMEM_DOUT12_MODE_M  (BIT(4))
#define SPI_MEM_SMEM_DOUT12_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT12_MODE_S  4
/* SPI_MEM_SMEM_DOUT11_MODE : HRO ;bitpos:[3] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT11_MODE    (BIT(3))
#define SPI_MEM_SMEM_DOUT11_MODE_M  (BIT(3))
#define SPI_MEM_SMEM_DOUT11_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT11_MODE_S  3
/* SPI_MEM_SMEM_DOUT10_MODE : HRO ;bitpos:[2] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT10_MODE    (BIT(2))
#define SPI_MEM_SMEM_DOUT10_MODE_M  (BIT(2))
#define SPI_MEM_SMEM_DOUT10_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT10_MODE_S  2
/* SPI_MEM_SMEM_DOUT09_MODE : HRO ;bitpos:[1] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT09_MODE    (BIT(1))
#define SPI_MEM_SMEM_DOUT09_MODE_M  (BIT(1))
#define SPI_MEM_SMEM_DOUT09_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT09_MODE_S  1
/* SPI_MEM_SMEM_DOUT08_MODE : HRO ;bitpos:[0] ;default: 1'h0 ; */
/*description: the output signals are delayed by system clock cycles, 0: output without delayed
, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3:
 output with the posedge of clk_160,4 output with the negedge of clk_160,5: outp
ut with the spi_clk high edge ,6: output with the spi_clk low edge.*/
#define SPI_MEM_SMEM_DOUT08_MODE    (BIT(0))
#define SPI_MEM_SMEM_DOUT08_MODE_M  (BIT(0))
#define SPI_MEM_SMEM_DOUT08_MODE_V  0x1
#define SPI_MEM_SMEM_DOUT08_MODE_S  0
...
/* SPI_MEM_XTS_PHYSICAL_ADDRESS : R/W ;bitpos:[29:0] ;default: 30'h0 ; */
...
/* SPI_MEM_XTS_DATE : R/W ;bitpos:[29:0] ;default: 30'h20210907 ; */
...
/* SPI_MEM_MMU_MEM_FORCE_PU : R/W ;bitpos:[2] ;default: 1'b0 ; */
...
/* SPI_MEM_MMU_MEM_FORCE_PD : R/W ;bitpos:[1] ;default: 1'b1 ; */
...
/* SPI_MEM_DATE : R/W ;bitpos:[27:0] ;default: 28'h2401170 ; */
