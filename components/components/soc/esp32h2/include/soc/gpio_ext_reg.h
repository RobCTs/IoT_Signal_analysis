...
/** GPIO_EXT_PAD_COMP_INT_RAW : RO/WTC/SS; bitpos: [0]; default: 0;
 *  Pad compare raw interrupt
 */
#define GPIO_EXT_PAD_COMP_INT_RAW    (BIT(0))
#define GPIO_EXT_PAD_COMP_INT_RAW_M  (GPIO_EXT_PAD_COMP_INT_RAW_V << GPIO_EXT_PAD_COMP_INT_RAW_S)
#define GPIO_EXT_PAD_COMP_INT_RAW_V  0x00000001U
#define GPIO_EXT_PAD_COMP_INT_RAW_S  0

/** GPIO_EXT_INT_ST_REG register
 *  GPIO interrupt masked register
 */
#define GPIO_EXT_INT_ST_REG (DR_REG_GPIO_EXT_BASE + 0xe4)
/** GPIO_EXT_PAD_COMP_INT_ST : RO; bitpos: [0]; default: 0;
 *  Pad compare masked interrupt
 */
#define GPIO_EXT_PAD_COMP_INT_ST    (BIT(0))
#define GPIO_EXT_PAD_COMP_INT_ST_M  (GPIO_EXT_PAD_COMP_INT_ST_V << GPIO_EXT_PAD_COMP_INT_ST_S)
#define GPIO_EXT_PAD_COMP_INT_ST_V  0x00000001U
#define GPIO_EXT_PAD_COMP_INT_ST_S  0

/** GPIO_EXT_INT_ENA_REG register
 *  GPIO interrupt enable register
 */
#define GPIO_EXT_INT_ENA_REG (DR_REG_GPIO_EXT_BASE + 0xe8)
/** GPIO_EXT_PAD_COMP_INT_ENA : R/W; bitpos: [0]; default: 0;
 *  Pad compare interrupt enable
 */
#define GPIO_EXT_PAD_COMP_INT_ENA    (BIT(0))
#define GPIO_EXT_PAD_COMP_INT_ENA_M  (GPIO_EXT_PAD_COMP_INT_ENA_V << GPIO_EXT_PAD_COMP_INT_ENA_S)
#define GPIO_EXT_PAD_COMP_INT_ENA_V  0x00000001U
#define GPIO_EXT_PAD_COMP_INT_ENA_S  0

/** GPIO_EXT_INT_CLR_REG register
 *  GPIO interrupt clear register
 */
#define GPIO_EXT_INT_CLR_REG (DR_REG_GPIO_EXT_BASE + 0xec)
/** GPIO_EXT_PAD_COMP_INT_CLR : WT; bitpos: [0]; default: 0;
 *  Pad compare interrupt clear
 */
#define GPIO_EXT_PAD_COMP_INT_CLR    (BIT(0))
#define GPIO_EXT_PAD_COMP_INT_CLR_M  (GPIO_EXT_PAD_COMP_INT_CLR_V << GPIO_EXT_PAD_COMP_INT_CLR_S)
#define GPIO_EXT_PAD_COMP_INT_CLR_V  0x00000001U
#define GPIO_EXT_PAD_COMP_INT_CLR_S  0

/** GPIO_EXT_VERSION_REG register
 *  Version Control Register
 */
#define GPIO_EXT_VERSION_REG (DR_REG_GPIO_EXT_BASE + 0xfc)
/** GPIO_EXT_DATE : R/W; bitpos: [27:0]; default: 35684640;
 *  Version control register.
 */
