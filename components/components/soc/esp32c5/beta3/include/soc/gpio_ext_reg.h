...
/** GPIO_EXT_FUNCTION_CLK_EN : R/W; bitpos: [30]; default: 0;
 *  Clock enable bit of sigma delta modulation.
 */
#define GPIO_EXT_FUNCTION_CLK_EN    (BIT(30))
#define GPIO_EXT_FUNCTION_CLK_EN_M  (GPIO_EXT_FUNCTION_CLK_EN_V << GPIO_EXT_FUNCTION_CLK_EN_S)
#define GPIO_EXT_FUNCTION_CLK_EN_V  0x00000001U
#define GPIO_EXT_FUNCTION_CLK_EN_S  30
/** GPIO_EXT_SPI_SWAP : R/W; bitpos: [31]; default: 0;
 *  Reserved.
 */
#define GPIO_EXT_SPI_SWAP    (BIT(31))
#define GPIO_EXT_SPI_SWAP_M  (GPIO_EXT_SPI_SWAP_V << GPIO_EXT_SPI_SWAP_S)
#define GPIO_EXT_SPI_SWAP_V  0x00000001U
#define GPIO_EXT_SPI_SWAP_S  31

/** GPIO_EXT_PAD_COMP_CONFIG_REG register
 *  PAD Compare configure Register
 */
#define GPIO_EXT_PAD_COMP_CONFIG_REG (DR_REG_GPIO_EXT_BASE + 0x28)
/** GPIO_EXT_XPD_COMP : R/W; bitpos: [0]; default: 0;
 *  Pad compare enable bit.
 */
#define GPIO_EXT_XPD_COMP    (BIT(0))
#define GPIO_EXT_XPD_COMP_M  (GPIO_EXT_XPD_COMP_V << GPIO_EXT_XPD_COMP_S)
#define GPIO_EXT_XPD_COMP_V  0x00000001U
#define GPIO_EXT_XPD_COMP_S  0
/** GPIO_EXT_MODE_COMP : R/W; bitpos: [1]; default: 0;
 *  1 to enable external reference from PAD[0]. 0 to enable internal reference,
 *  meanwhile PAD[0] can be used as a regular GPIO.
 */
#define GPIO_EXT_MODE_COMP    (BIT(1))
#define GPIO_EXT_MODE_COMP_M  (GPIO_EXT_MODE_COMP_V << GPIO_EXT_MODE_COMP_S)
#define GPIO_EXT_MODE_COMP_V  0x00000001U
#define GPIO_EXT_MODE_COMP_S  1
/** GPIO_EXT_DREF_COMP : R/W; bitpos: [4:2]; default: 0;
 *  internal reference voltage tuning bit. 0V to 0.7*VDDPST step 0.1*VDDPST.
 */
#define GPIO_EXT_DREF_COMP    0x00000007U
#define GPIO_EXT_DREF_COMP_M  (GPIO_EXT_DREF_COMP_V << GPIO_EXT_DREF_COMP_S)
#define GPIO_EXT_DREF_COMP_V  0x00000007U
#define GPIO_EXT_DREF_COMP_S  2
/** GPIO_EXT_ZERO_DET_MODE : R/W; bitpos: [6:5]; default: 0;
 *  Zero Detect mode select.
 */
#define GPIO_EXT_ZERO_DET_MODE    0x00000003U
#define GPIO_EXT_ZERO_DET_MODE_M  (GPIO_EXT_ZERO_DET_MODE_V << GPIO_EXT_ZERO_DET_MODE_S)
#define GPIO_EXT_ZERO_DET_MODE_V  0x00000003U
#define GPIO_EXT_ZERO_DET_MODE_S  5

/** GPIO_EXT_PAD_COMP_FILTER_REG register
 *  Zero Detect filter Register
 */
#define GPIO_EXT_PAD_COMP_FILTER_REG (DR_REG_GPIO_EXT_BASE + 0x2c)
/** GPIO_EXT_ZERO_DET_FILTER_CNT : R/W; bitpos: [31:0]; default: 0;
 *  Zero Detect filter cycle length
 */
#define GPIO_EXT_ZERO_DET_FILTER_CNT    0xFFFFFFFFU
#define GPIO_EXT_ZERO_DET_FILTER_CNT_M  (GPIO_EXT_ZERO_DET_FILTER_CNT_V << GPIO_EXT_ZERO_DET_FILTER_CNT_S)
#define GPIO_EXT_ZERO_DET_FILTER_CNT_V  0xFFFFFFFFU
#define GPIO_EXT_ZERO_DET_FILTER_CNT_S  0
 ...
 */
#define GPIO_EXT_INT_RAW_REG (DR_REG_GPIO_EXT_BASE + 0xe0)
/** GPIO_EXT_COMP0_NEG_INT_RAW : RO/WTC/SS; bitpos: [0]; default: 0;
 *  analog comparator pos edge interrupt raw
 */
#define GPIO_EXT_COMP0_NEG_INT_RAW    (BIT(0))
#define GPIO_EXT_COMP0_NEG_INT_RAW_M  (GPIO_EXT_COMP0_NEG_INT_RAW_V << GPIO_EXT_COMP0_NEG_INT_RAW_S)
#define GPIO_EXT_COMP0_NEG_INT_RAW_V  0x00000001U
#define GPIO_EXT_COMP0_NEG_INT_RAW_S  0
/** GPIO_EXT_COMP0_POS_INT_RAW : RO/WTC/SS; bitpos: [1]; default: 0;
 *  analog comparator neg edge interrupt raw
 */
#define GPIO_EXT_COMP0_POS_INT_RAW    (BIT(1))
#define GPIO_EXT_COMP0_POS_INT_RAW_M  (GPIO_EXT_COMP0_POS_INT_RAW_V << GPIO_EXT_COMP0_POS_INT_RAW_S)
#define GPIO_EXT_COMP0_POS_INT_RAW_V  0x00000001U
#define GPIO_EXT_COMP0_POS_INT_RAW_S  1
/** GPIO_EXT_COMP0_ALL_INT_RAW : RO/WTC/SS; bitpos: [2]; default: 0;
 *  analog comparator neg or pos edge interrupt raw
 */
#define GPIO_EXT_COMP0_ALL_INT_RAW    (BIT(2))
#define GPIO_EXT_COMP0_ALL_INT_RAW_M  (GPIO_EXT_COMP0_ALL_INT_RAW_V << GPIO_EXT_COMP0_ALL_INT_RAW_S)
#define GPIO_EXT_COMP0_ALL_INT_RAW_V  0x00000001U
#define GPIO_EXT_COMP0_ALL_INT_RAW_S  2

/** GPIO_EXT_INT_ST_REG register
 *  GPIOSD interrupt masked register
 */
#define GPIO_EXT_INT_ST_REG (DR_REG_GPIO_EXT_BASE + 0xe4)
/** GPIO_EXT_COMP0_NEG_INT_ST : RO; bitpos: [0]; default: 0;
 *  analog comparator pos edge interrupt status
 */
#define GPIO_EXT_COMP0_NEG_INT_ST    (BIT(0))
#define GPIO_EXT_COMP0_NEG_INT_ST_M  (GPIO_EXT_COMP0_NEG_INT_ST_V << GPIO_EXT_COMP0_NEG_INT_ST_S)
#define GPIO_EXT_COMP0_NEG_INT_ST_V  0x00000001U
#define GPIO_EXT_COMP0_NEG_INT_ST_S  0
/** GPIO_EXT_COMP0_POS_INT_ST : RO; bitpos: [1]; default: 0;
 *  analog comparator neg edge interrupt status
 */
#define GPIO_EXT_COMP0_POS_INT_ST    (BIT(1))
#define GPIO_EXT_COMP0_POS_INT_ST_M  (GPIO_EXT_COMP0_POS_INT_ST_V << GPIO_EXT_COMP0_POS_INT_ST_S)
#define GPIO_EXT_COMP0_POS_INT_ST_V  0x00000001U
#define GPIO_EXT_COMP0_POS_INT_ST_S  1
/** GPIO_EXT_COMP0_ALL_INT_ST : RO; bitpos: [2]; default: 0;
 *  analog comparator neg or pos edge interrupt status
 */
#define GPIO_EXT_COMP0_ALL_INT_ST    (BIT(2))
#define GPIO_EXT_COMP0_ALL_INT_ST_M  (GPIO_EXT_COMP0_ALL_INT_ST_V << GPIO_EXT_COMP0_ALL_INT_ST_S)
#define GPIO_EXT_COMP0_ALL_INT_ST_V  0x00000001U
#define GPIO_EXT_COMP0_ALL_INT_ST_S  2

/** GPIO_EXT_INT_ENA_REG register
 *  GPIOSD interrupt enable register
 */
#define GPIO_EXT_INT_ENA_REG (DR_REG_GPIO_EXT_BASE + 0xe8)
/** GPIO_EXT_COMP0_NEG_INT_ENA : R/W; bitpos: [0]; default: 1;
 *  analog comparator pos edge interrupt enable
 */
#define GPIO_EXT_COMP0_NEG_INT_ENA    (BIT(0))
#define GPIO_EXT_COMP0_NEG_INT_ENA_M  (GPIO_EXT_COMP0_NEG_INT_ENA_V << GPIO_EXT_COMP0_NEG_INT_ENA_S)
#define GPIO_EXT_COMP0_NEG_INT_ENA_V  0x00000001U
#define GPIO_EXT_COMP0_NEG_INT_ENA_S  0
/** GPIO_EXT_COMP0_POS_INT_ENA : R/W; bitpos: [1]; default: 1;
 *  analog comparator neg edge interrupt enable
 */
#define GPIO_EXT_COMP0_POS_INT_ENA    (BIT(1))
#define GPIO_EXT_COMP0_POS_INT_ENA_M  (GPIO_EXT_COMP0_POS_INT_ENA_V << GPIO_EXT_COMP0_POS_INT_ENA_S)
#define GPIO_EXT_COMP0_POS_INT_ENA_V  0x00000001U
#define GPIO_EXT_COMP0_POS_INT_ENA_S  1
/** GPIO_EXT_COMP0_ALL_INT_ENA : R/W; bitpos: [2]; default: 1;
 *  analog comparator neg or pos edge interrupt enable
 */
#define GPIO_EXT_COMP0_ALL_INT_ENA    (BIT(2))
#define GPIO_EXT_COMP0_ALL_INT_ENA_M  (GPIO_EXT_COMP0_ALL_INT_ENA_V << GPIO_EXT_COMP0_ALL_INT_ENA_S)
#define GPIO_EXT_COMP0_ALL_INT_ENA_V  0x00000001U
#define GPIO_EXT_COMP0_ALL_INT_ENA_S  2

/** GPIO_EXT_INT_CLR_REG register
 *  GPIOSD interrupt clear register
 */
#define GPIO_EXT_INT_CLR_REG (DR_REG_GPIO_EXT_BASE + 0xec)
/** GPIO_EXT_COMP0_NEG_INT_CLR : WT; bitpos: [0]; default: 0;
 *  analog comparator pos edge interrupt clear
 */
#define GPIO_EXT_COMP0_NEG_INT_CLR    (BIT(0))
#define GPIO_EXT_COMP0_NEG_INT_CLR_M  (GPIO_EXT_COMP0_NEG_INT_CLR_V << GPIO_EXT_COMP0_NEG_INT_CLR_S)
#define GPIO_EXT_COMP0_NEG_INT_CLR_V  0x00000001U
#define GPIO_EXT_COMP0_NEG_INT_CLR_S  0
/** GPIO_EXT_COMP0_POS_INT_CLR : WT; bitpos: [1]; default: 0;
 *  analog comparator neg edge interrupt clear
 */
#define GPIO_EXT_COMP0_POS_INT_CLR    (BIT(1))
#define GPIO_EXT_COMP0_POS_INT_CLR_M  (GPIO_EXT_COMP0_POS_INT_CLR_V << GPIO_EXT_COMP0_POS_INT_CLR_S)
#define GPIO_EXT_COMP0_POS_INT_CLR_V  0x00000001U
#define GPIO_EXT_COMP0_POS_INT_CLR_S  1
/** GPIO_EXT_COMP0_ALL_INT_CLR : WT; bitpos: [2]; default: 0;
 *  analog comparator neg or pos edge interrupt clear
 */
#define GPIO_EXT_COMP0_ALL_INT_CLR    (BIT(2))
#define GPIO_EXT_COMP0_ALL_INT_CLR_M  (GPIO_EXT_COMP0_ALL_INT_CLR_V << GPIO_EXT_COMP0_ALL_INT_CLR_S)
#define GPIO_EXT_COMP0_ALL_INT_CLR_V  0x00000001U
#define GPIO_EXT_COMP0_ALL_INT_CLR_S  2

/** GPIO_EXT_VERSION_REG register
 *  Version Control Register
 */
#define GPIO_EXT_VERSION_REG (DR_REG_GPIO_EXT_BASE + 0xfc)
/** GPIO_EXT_GPIO_SD_DATE : R/W; bitpos: [27:0]; default: 36704513;
 *  Version control register.
 */
#define GPIO_EXT_GPIO_SD_DATE    0x0FFFFFFFU
#define GPIO_EXT_GPIO_SD_DATE_M  (GPIO_EXT_GPIO_SD_DATE_V << GPIO_EXT_GPIO_SD_DATE_S)
