 ...
 *  For SPI0 external RAM  interface, 1: spi_mem_clk is eqaul to system 0: spi_mem_clk
 ...
 *  Used with SPI_MEM_NAND_FLASH_SEQ_USR_TRIG to indecate the last page program ,and to
 *  excute page excute. 1: write end 0: write in a page size.
 */
 ...
 *  xts aes peseudo function base round that must be peformed.
 */
 ...
 *  xts aes peseudo function increment round that will be peformed randomly between 0 &
 *  2**(inc+1).
 */
