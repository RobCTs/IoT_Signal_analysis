...
// void store_mqtt_credentials(const char* key_cert, const char* client_cert);
// void retrieve_mqtt_credentials(char* key_cert, size_t key_cert_size, char* client_cert, size_t client_cert_size);
